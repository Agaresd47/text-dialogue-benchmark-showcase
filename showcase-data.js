window.SHOWCASE_DATA = {
  ...
  highlights: [
    {
      title: "B3-SUSPEND-01 补齐了“低显性表达，需主动感知”这一类的复杂中间态",
      detail: "该案例补足了先前较弱的核心案例位置，将“松下来却更悬空”的状态纳入评测集。",
    },
    {
      title: "项目已形成正式评测集",
    ...
    {
      title: "后续精炼优先级仍在“低显性表达，需主动感知”这一类",
      detail: "如果后续继续替换样本，优先方向应是进一步加强这一类案例中的复杂中间态。",
    },
  ],
  strategyHypothesis: [
    {
