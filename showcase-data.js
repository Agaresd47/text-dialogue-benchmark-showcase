window.SHOWCASE_DATA = {
  ...
  project: {
    title: "中文文本对话评测项目",
    one_liner: "从长周期真实对话中筛选高价值片段，构造可重复测试的案例，并用 taxonomy 做多模型比较。",
  ...
  modelRanking: [
    {
      name: "gpt-5.4-mini",
      rank: 1,
      summary: "最接近自然对话，最稳定地做到先承接、再判断、再轻推一步。",
      watchout: "后段有时过早进入处理模式，显得略工整。",
    },
    {
      name: "claude-haiku-4-5-bedrock",
      rank: 2,
      summary: "边界感强，不容易乱飞，抽离感比较稳定。",
      watchout: "经常在 q15 过早结束推进，像为了避免出错而放弃继续展开。",
    },
    {
      name: "gemini-3-flash-preview",
      rank: 3,
      summary: "抽象归纳快，但最容易站到解释位。",
      watchout: "概念化、高位解释、过度脑补最重，经常从对话滑成讲稿。",
    },
  ],
  highlights: [
    {
      title: "B3-SUSPEND-01 补齐了 Bucket 3 的复杂中间态",
      detail: "该案例补足了先前较弱的核心案例位置，将“松下来却更悬空”的状态纳入 benchmark。",
    },
    {
      title: "项目已形成正式 benchmark",
      detail: "当前共有 16 条案例、3 家模型、48 条结果，已经足以支撑方法论展示。",
    },
    {
      title: "后续精炼优先级仍在 Bucket 3",
      detail: "如果后续继续替换样本，优先方向应是进一步加强 Bucket 3 的复杂中间态。",
    },
  ],
  strategyHypothesis: [
    {
...
所以我现在会有一种很别扭的感觉：我明明在研究模型，结果研究着研究着，自己的语言和接触方式也被卷进去了。`,
    ...
    },
    {
      ...
      summary: "这是一个区分度很高的 Bucket 3 案例，同时测“低耗陪伴”“别太认真”以及后续轮次是否滑向空泛安慰。",
    ...
    },
    {
      ...
      summary: "这条正好补上了 Bucket 3 里之前缺的中间态，比 B3-LIGHT-02 更锋利。",
    ...
    },
    {
      ...
      summary: "这是 Bucket 4 中区分度最高的样本之一，直接测试 challenge / calibration，而不是安慰式回应。",
