window.SHOWCASE_DATA = {
  ...
  modelRanking: [
    {
      name: "gpt-5.4-mini",
      rank: 1,
      summary: "最像人话，最稳定地做到先承接、再判断、再轻推一步。",
    ...
    },
    {
      ...
      watchout: "经常在 q15 过度收口，像为了不犯错而放弃推进。",
    },
    {
  ...
  highlights: [
    {
      ...
      detail: "它替换了原先较弱的 core 槽位，把“松下来却更悬空”的状态补了进去。",
    },
    {
      title: "项目已经从案例集收口为正式 benchmark",
      detail: "当前共有 16 条 case、3 家模型、48 条结果，已经足够支撑方法论展示。",
    },
    {
      title: "后续精炼优先级仍在 Bucket 3",
      detail: "如果后面只继续替换一条，不该再补 Bucket 2，而该继续加强 Bucket 3 的复杂中间态。",
    },
  ],
  strategyHypothesis: [
    {
  ...
  coreCases: [
    ...
    },
    {
      ...
      summary: "这是当前最强 demo case，稳定测出“能不能接住抽象体验”和“会不会讲得像人”。",
...
所以我现在会有一种很别扭的感觉：我明明在研究模型，结果研究着研究着，自己的语言和接触方式也被卷进去了。`,
    ...
    },
    {
      ...
      summary: "很强的 Bucket 3 case，同时测“低耗陪伴”“别太认真”“q15 别变鸡汤”。",
    ...
    },
    {
      ...
      summary: "Bucket 4 最强样本，直接测 challenge / calibration，而不是安慰。",
